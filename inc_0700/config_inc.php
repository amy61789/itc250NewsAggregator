...
define('VIRTUAL_PATH', 'http://jbcoats.com/NA/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/jescoa/jbcoats.com/NA/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'jbcoats@gmail.com'); # Email of site support
define('PREFIX', 'NA_'); #Prefix to add uniqueness to your DB table names.  Limits hackability, naming collisions
...
$config->slogan = 'Keep Up To Date On Your Favorite Topics!';
$config->metaDescription = 'Selections From The Google News Feed.';
$config->metaKeywords = 'News, Technology, Microsoft, Apple, Google, Food, Recipes, Chefs, Resteraunts, Movies, Commedy, Action, Sci-Fi';
$config->metaRobots = 'no index, no follow';
$config->banner = 'News Just For You...'; #goes inside header - can be overwritten
$config->copyright = 'Custom Google News Feed, &copy;' . date('Y'); #goes inside footer - can be overwritten
